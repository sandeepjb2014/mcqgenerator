...
# installed.
TCL_PREFIX='C:/Users/sande/mcqgenerator/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Users/sande/mcqgenerator/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Users/sande/mcqgenerator/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Users/sande/mcqgenerator/env\Library\include'
...
TCL_PACKAGE_PATH='C:/Users/sande/mcqgenerator/env\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Users/sande/mcqgenerator/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Users/sande/mcqgenerator/env\Library\lib\tclstub86.lib'
